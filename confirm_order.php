			...
			<div style="border: 1px lightgrey solid; margin-left: 30%;" class="col-md-5">
				...
				<div class="row">
					<div style="padding: 0" class="col-md-5">
						<div class="img-fluid" style="width:240px; height:190px; background-color: black; background-image: url('<?php if (isset($gigimage)) {
								 echo $gigimage;
				...
				<div class="row">
					...
					?>
					<div class="col-md-5"></div>
					<div class="col-md-7"><input style="margin-bottom: 5%; margin-top: 5%;" class="btn btn-md join-button" type="submit" value="Order" name="submit" onclick="payWithPaystack(<?php echo $orderprice; ?>, <?php echo $gigid; ?>)"></div>
				</div>
