		...
		<?php
			...
			$result = $orderobj->getOrdersForBuyer($_GET['id']);
			...
			<div class="col-md table-responsive">
				<div class="collapse show active" id="collapseNew">
				  <div class="card card-body" >
				    <div class="row">
				    	<div class="col-md-6"><p>ORDERS</p></div>
				    			...
				    			<tbody>
				    				...
				    				<tr>
				    					...
				    					<?php}elseif($value['order_status'] == 'Cancelled'){?>
				    						...
				    						<td></td>
				    					<?php}elseif($value['order_status'] != 'Cancelled' && $value['order_status'] != 'Completed' && $value['order_status'] != 'Revision Requested' && echodate('Y m d')< $orderdue){?>
